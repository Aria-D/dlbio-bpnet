...
class TaskSpec(RelatedConfigMixin):
    ...
    def load_counts(self, intervals, use_strand=False, progbar=False): # changed use_strand = True
        import numpy as np
...
class DataSpec(RelatedLoadSaveMixin):
    ...
    def load_bias_counts(self, intervals, use_strand=False, progbar=False): # changed use_strand = True
        return {task: ts.load_counts(intervals, use_strand=use_strand, progbar=progbar)
